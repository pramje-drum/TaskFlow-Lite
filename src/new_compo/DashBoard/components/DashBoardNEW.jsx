...
const DashboardNEW = () => {
	...
	return (
		<div className="p-6 min-h-screen bg-bg_color flex flex-col items-center">
			<button
				onClick={() => {
					setIsOpen(true);
					setEditingTask(null);
				}}
				className="px-6 py-3 bg-task_border_color border-white border text-white rounded-xl mb-6 cursor-pointer"
			>
				Add Task
			</button>
			...
			<Modal
				...
				className="bg-task_border_color text-white border-white border-2 w-full max-w-160 rounded-2xl shadow-2xl outline-none"
			>
				<div className="flex justify-between items-center bg-bg_color rounded-2xl px-6 py-4 border-b">
